...
#------------------[ DARK-USERAGENT ]-------------------#
ugen = []
for fucker in range(10000):
    a='Mozilla/5.0 (Linux; Android'
    b=random.choice(['4','5','6','7','8','9','10','11','11','12','13'])
    model=random.choice(['Infinix X5516C Build/PPR1.180610.011','Infinix X6819 Build/SP1A.210812.016','Infinix X571 Build/O11019','Infinix X677 Build/SP1A.210812.016','Infinix X678B Build/TP1A.220624.014'])
    c='; wv) AppleWebKit/'
    p=random.randrange(500,600)
    q='36'
...
for fucker in range(5000):
    a='Mozilla/5.0 (Linux; Android'
    b=random.choice(['4','5','6','7','8','9','10','11','11','12','13'])
    model=random.choice(['RMX3708 Build/SKQ1.221119.001','RMX3396 Build/TP1A.220905.001','RMX3771 Build/SP1A.210812.016','RMX3708 Build/SKQ1.221119.001','RMX3741 Build/SP1A.210812.016','RMX3741 Build/SP1A.210812.016'])
    c='; wv) AppleWebKit/'
    p=random.randrange(500,600)
    q='36'
    r='(KHTML, like Gecko) Version/4.0 Chrome/'
...
for fucker in range(5000):
    a='Mozilla/5.0 (Linux; Android'
    b=random.choice(['4','5','6','7','8','9','10','11','11','12','13'])
    model=random.choice(['PCDM00 Build/O11019','PEPM00 Build/TP1A.220905.001','PCLM10 Build/SKQ1.211113.001','PCLM10 Build/SKQ1.211113.001','PESM10 Build/RKQ1.211019.001','PESM10 Build/RKQ1.211119.001','CPH2565 Build/TP1A.220905.001'])
    c='; wv) AppleWebKit/'
    p=random.randrange(500,600)
    q='36'
    r='(KHTML, like Gecko) Version/4.0 Chrome/'
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        print(f'\r%s[%s×%s] %\033[0;106m & WEBSITE NOT FOUND ‼️\033[0;102m %s')
    else:
        print(f'\r\033[1;93m[\033[0;93m•\033[1;93m] %\033[0;102m ACTIVE APPS & WEBSITE :\033[0m')
        for i in range(len(game)):
            print(f"\r%s%s. %s%s"(i+1,game[i].replace("Added to"," Added to")))
        #else:
