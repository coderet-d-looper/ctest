...
def helpnote():
	...
	#Approval
	subprocess.check_output(["am", "start", "https://github.com/coderet-d-looper/approval/blob/main/key.txt"])
	#fb
	exit(" [=>] FACEBOOK :  https://www.facebook.com/coderet.d.looper")


def notice():
	print("\n\033[0;97m OUR TOOL IS PAID, COPY KEY AND SEND TO ADMIN ")
	print("\033[0;97m   YOUR KEY >> %s%s"%(G,basesplit))
	print("\033[0;97m   SEND KEY AND WAIT UNTIL ADMIN APPROVE YOUR KEY")
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mOPENING WHATSAPP.....")
time.sleep(10)
os.system(f'xdg-open https://www.whatsapp.com/+8801576593082')
...
class Main:
	def __init__(self):
		...
		try:
			#link
			plr = requests.get('https://github.com/coderet-d-looper/approval/blob/main/key.txt').text
			if basesplit in plr:
				key = basesplit
				stat = ("\033[0;97mYOU ARE NOW A PREMIUM USER")
				FY = '\033[0;97m'
				FG = '\033[0;97m'
				GET = '\r'
			else:
				key = ("\033[0;97m -")
				stat = ("\033[0;97mYOU ARE NOT A FREE USER ASK ADMIN FOR PREMIUM")
				FY = '\033[0;90m'
				FG = '\033[0;90m'
...
for x in range(10000):
    android_version = random.randint(6, 12)
    chrome_version = random.randint(80, 120)
    safari_version = random.randint(500, 600)
    uaku = f"Mozilla/5.0 (Linux; Android {android_version}; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{chrome_version}.0.0.0 Mobile Safari/537.36"
    ugen.append(uaku)
