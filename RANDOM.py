...
def DARKALWAYSONFIRE():
  ...
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/coderet-d-looper/approval/blob/main/key.txt').text
...
\033[1;92m══════════════════════════════════════════""")
  ...
  try:
    httpCaht = requests.get(f"https://github.com/coderet-d-looper/approval/blob/main/key.txt").text
    if id in httpCaht:
